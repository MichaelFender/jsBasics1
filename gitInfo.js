...
//CODE HERE
let gitDefinition = ('Git is a version control system where developers can manage and keep track of source code history.')
...
//CODE HERE
let git = [{description: 'This command creates an empty Git repository'}, {code: 'git init'}]
console.log (git)
...
//CODE HERE
let clone = [{description: 'This command Clones a repository into a newly created directory'}, {code: 'git clone'}]
console.log (clone)
